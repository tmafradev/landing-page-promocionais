...
function App() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
        ...
        {/* Título */}
        <h1 className="font-['Orbitron'] font-medium text-center text-white max-w-[900px] text-[30px] leading-[38px] md:text-[72px] md:leading-[90px] px-2 hero-animate-1">
        ...
        {/* Subtítulo */}
        <p className="mt-6 text-base text-center relative z-10 hero-animate-2">
        ...
        {/* Caixa */}
        <div className="mt-10 max-w-[700px] w-full rounded-[10px] border border-[#00D9FF]/30 bg-gradient-to-r from-[#000000] to-[#00D9FF]/5 px-8 py-6 text-center relative z-10 hero-animate-3">
      ...
      <section className="px-4 py-20 flex flex-col items-center">
        ...
        <div className="mt-12 max-w-[700px] w-full flex flex-col gap-5">
          ...
          {/* Card 1 */}
          <Reveal delay={0.1}>
            <div className="flex items-center gap-3 border border-[#FB2C36] rounded-xl px-4 py-5 bg-black shadow-[0_0_25px_rgba(251,44,54,0.35)]">
              <div className="flex-shrink-0 w-7 h-7 rounded-full border border-[#FB2C36] bg-[#FB2C36]/20 flex items-center justify-center">
                <span className="text-[#FB2C36] font-bold text-xs">&#10005;</span>
              </div>
        ...
        {/* Caixa azul */}
        <Reveal delay={0.15} className="mt-10 max-w-[700px] w-full">
          <div className="rounded-lg border-l-4 border-[#00D9FF] bg-gradient-to-r from-[#00D9FF]/10 to-transparent px-8 py-6">
      ...
      <section className="px-4 py-20 relative overflow-hidden">
        ...
        <div className="max-w-[1000px] mx-auto flex flex-col md:flex-row items-center gap-10 relative z-10">
          ...
          <Reveal className="flex-1">
            <h2 className="font-['Orbitron'] font-medium text-[26px] leading-[34px] md:text-[36px] md:leading-[45px] text-white text-center md:text-left">
              Existe um <span className="text-[#00D9FF]">método simples</span><br />
              para criar campanhas que<br />
              funcionam
            </h2>
            <p className="mt-6 font-['Inter'] font-light text-[16px] md:text-[18px] md:leading-[28px] text-white/70 text-center md:text-left">
      ...
      <section className="px-4 py-20 flex flex-col items-center">
        ...
        <div className="mt-12 max-w-[1000px] w-full flex flex-col md:flex-row items-stretch gap-8">
          ...
          {/* Imagem esquerda */}
          <Reveal className="flex-1 flex items-center justify-center">
            <img
  ...
  <span className="font-['Inter'] font-light text-[20px] md:text-[30px] text-white">por apenas</span>
  ...
  <span className="font-['Inter'] font-light text-[20px] md:text-[24px] text-white">,00</span>
        ...
        {/* Observação */}
        <Reveal delay={0.1}>
          <p className="mt-6 font-['Inter'] font-light italic text-[14px] text-white/60 text-center max-w-[600px]">
            Garantia abaixo do botão — nunca acima. Acima gera dúvida. Abaixo silencia a voz racional depois da decisão.
          </p>
        </Reveal>
      </section>
        ...
        <div className="mt-12 max-w-[700px] w-full flex flex-col gap-4">
          {faqs.map((faq, index) => (
            <Reveal key={index} delay={0.1 + index * 0.1}>
              <div className="border border-[#00D9FF] rounded-lg overflow-hidden">
                <button
