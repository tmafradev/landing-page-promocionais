  ...
  return (
    <div className="bg-black text-white overflow-x-hidden">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <h1 className="font-['Orbitron'] font-medium text-center text-white max-w-[900px] text-[30px] leading-[38px] md:text-[72px] md:leading-[90px]">
        ...
        <p className="mt-6 text-base text-center px-4">
        ...
        <div className="mt-10 max-w-[700px] w-full rounded-[10px] border border-[#00D9FF]/30 bg-gradient-to-r from-[#000000] to-[#00D9FF]/5 px-6 py-6 text-center relative z-10 mx-4">
        ...
        <a
          ...
          className="mt-10 relative z-10 inline-block text-center font-['Orbitron'] font-bold text-black bg-gradient-to-r from-[#00D9FF] to-[#00A8CC] px-6 md:px-10 py-4 rounded-lg hover:shadow-[0_0_30px_rgba(0,217,255,0.4)] hover:scale-105 transition-all duration-300 text-[14px] md:text-[18px] mx-4"
        >
      ...
      <section className="px-4 py-20 flex flex-col items-center">
        <h2 className="font-['Orbitron'] font-medium text-center text-[28px] leading-[36px] md:text-[48px] md:leading-[48px]">
        ...
        <div className="mt-12 max-w-[700px] w-full flex flex-col gap-5">
          <div className="flex items-center gap-4 border border-[#FB2C36] rounded-xl px-4 md:px-6 py-5 bg-black shadow-[0_0_25px_rgba(251,44,54,0.35)]">
            ...
            <p className="font-['Inter'] font-light text-[15px] md:text-[18px] text-white">
        ...
        <div className="mt-10 max-w-[700px] w-full rounded-lg border-l-4 border-[#00D9FF] bg-gradient-to-r from-[#00D9FF]/10 to-transparent px-6 md:px-8 py-6">
        ...
        <a
          href="https://pay.hotmart.com/J102080283U?checkoutMode=10&bid=1776263928555"
          className="mt-10 inline-block text-center font-['Orbitron'] font-bold text-black bg-gradient-to-r from-[#00D9FF] to-[#00A8CC] px-8 md:px-10 py-4 rounded-lg hover:shadow-[0_0_30px_rgba(0,217,255,0.4)] hover:scale-105 transition-all duration-300 text-[14px] md:text-[18px]"
        >
          Quero estruturar minhas campanhas &#8594;
        </a>
      </section>
      ...
      <section className="px-4 py-20 relative overflow-hidden">
        ...
        <div className="max-w-[1000px] mx-auto flex flex-col md:flex-row items-center gap-10 relative z-10">
          <div className="flex-1 text-center md:text-left">
            <h2 className="font-['Orbitron'] font-medium text-[26px] leading-[34px] md:text-[36px] md:leading-[45px] text-white">
              Existe um <span className="text-[#00D9FF]">método simples</span> para criar campanhas que funcionam
            </h2>
            <p className="mt-6 font-['Inter'] font-light text-[16px] md:text-[18px] md:leading-[28px] text-white/70">
              e se repetem, sem precisar reinventar a roda a cada mês. Com ele você:
            </p>
          </div>
        ...
        <div className="max-w-[1000px] mx-auto mt-12 grid grid-cols-1 md:grid-cols-2 gap-5 relative z-10">
          <div className="rounded-[10px] border border-[#00D9FF]/30 bg-gradient-to-r from-[#000000] to-[#00D9FF]/5 px-5 py-5 flex items-start gap-4">
        ...
        <div className="flex justify-center mt-12 relative z-10">
          <a
            href="https://pay.hotmart.com/J102080283U?checkoutMode=10&bid=1776263928555"
            className="inline-block text-center font-['Orbitron'] font-bold text-black bg-gradient-to-r from-[#00D9FF] to-[#00A8CC] px-8 md:px-10 py-4 rounded-lg hover:shadow-[0_0_30px_rgba(0,217,255,0.4)] hover:scale-105 transition-all duration-300 text-[14px] md:text-[18px]"
          >
            Quero estruturar minhas campanhas &#8594;
          </a>
        </div>
      ...
      <section className="px-4 py-20 flex flex-col items-center">
        <h2 className="font-['Orbitron'] font-medium text-center text-[28px] leading-[36px] md:text-[48px] md:leading-[56px]">
        ...
        <div className="mt-12 max-w-[1000px] w-full flex flex-col md:flex-row items-stretch gap-8">
          ...
          <div className="flex-1 flex flex-col">
            <div className="border border-[#00D9FF]/30 rounded-xl px-6 md:px-8 py-8 flex-1">
              <h3 className="font-['Orbitron'] font-medium text-[24px] text-[#00D9FF]">João Navia</h3>
              <p className="mt-4 font-['Inter'] font-light text-[15px] md:text-[16px] leading-[24px] md:leading-[26px] text-white">
              ...
              <p className="mt-4 font-['Inter'] font-light text-[15px] md:text-[16px] leading-[24px] text-white">
                Mais de{' '}
                <span className="font-['Orbitron'] font-medium text-[#00D9FF]">305 aulas e treinamentos</span>
                {' '}ministrados.
              </p>
              <p className="mt-2 font-['Inter'] font-light text-[15px] md:text-[16px] leading-[24px] text-white">
                Fundador da{' '}
            ...
            <div className="mt-5 grid grid-cols-3 gap-2 md:gap-4">
              <div className="border border-[#00D9FF]/30 rounded-xl py-4 flex flex-col items-center gap-1 md:gap-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#00D9FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="8" r="5" />
                  <path d="M12 13l-3 7 3-2 3 2-3-7z" />
                </svg>
                <span className="font-['Orbitron'] font-bold text-[16px] md:text-[20px] text-[#00D9FF]">15+</span>
                <span className="font-['Inter'] font-light text-[12px] md:text-[14px] text-white">Anos</span>
              </div>
              ...
              <div className="border border-[#00D9FF]/30 rounded-xl py-4 flex flex-col items-center gap-1 md:gap-2">
                ...
                <span className="font-['Orbitron'] font-bold text-[16px] md:text-[20px] text-[#00D9FF]">305+</span>
                <span className="font-['Inter'] font-light text-[12px] md:text-[14px] text-white">Aulas</span>
              </div>
              ...
              <div className="border border-[#00D9FF]/30 rounded-xl py-4 flex flex-col items-center gap-1 md:gap-2">
                ...
                <span className="font-['Orbitron'] font-bold text-[16px] md:text-[20px] text-[#00D9FF]">RevOps</span>
                <span className="font-['Inter'] font-light text-[12px] md:text-[14px] text-white">Expert</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <a
          href="https://pay.hotmart.com/J102080283U?checkoutMode=10&bid=1776263928555"
          className="mt-12 inline-block text-center font-['Orbitron'] font-bold text-black bg-gradient-to-r from-[#00D9FF] to-[#00A8CC] px-8 md:px-10 py-4 rounded-lg hover:shadow-[0_0_30px_rgba(0,217,255,0.4)] hover:scale-105 transition-all duration-300 text-[14px] md:text-[18px]"
        >
          Quero estruturar minhas campanhas &#8594;
        </a>
      </section>
      ...
      <section className="px-4 py-20 flex flex-col items-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <div className="flex items-center gap-2 border border-[#00D9FF] rounded-full px-4 py-2">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00D9FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="23 7 16 12 23 17 23 7" />
              <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
            </svg>
            <span className="font-['Inter'] font-light text-[14px] md:text-[16px] text-white">Vídeo-aulas online</span>
          </div>
          <div className="flex items-center gap-2 border border-[#00D9FF] rounded-full px-4 py-2">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00D9FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
            </svg>
            <span className="font-['Inter'] font-light text-[14px] md:text-[16px] text-white">Acesso imediato</span>
          </div>
          <div className="flex items-center gap-2 border border-[#00D9FF] rounded-full px-4 py-2">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00D9FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="font-['Inter'] font-light text-[14px] md:text-[16px] text-white">Preço de lançamento</span>
          </div>
        </div>

        <div className="mt-10 max-w-[600px] w-full rounded-xl border border-[#00D9FF] shadow-[0_0_30px_rgba(0,217,255,0.3)] px-6 md:px-8 py-10 flex flex-col items-center">
          <p className="font-['Inter'] font-light text-[18px] text-white line-through">De R$297,00</p>
          <div className="mt-2 flex items-baseline flex-wrap justify-center">
            <span className="font-['Inter'] font-light text-[24px] md:text-[30px] text-white">por apenas</span>
            <span className="font-['Orbitron'] font-bold text-[56px] md:text-[72px] leading-none text-[#00D9FF] ml-3">R$37</span>
            <span className="font-['Inter'] font-light text-[20px] md:text-[24px] text-white">,00</span>
          </div>

          <a
            href="https://pay.hotmart.com/J102080283U?checkoutMode=10&bid=1776263928555"
            className="mt-8 w-full text-center inline-block font-['Orbitron'] font-bold text-black bg-gradient-to-r from-[#00D9FF] to-[#00A8CC] px-6 py-4 rounded-lg hover:shadow-[0_0_30px_rgba(0,217,255,0.4)] hover:scale-105 transition-all duration-300 text-[14px] md:text-[18px]"
          >
          ...
          <div className="mt-6 flex items-start gap-4">
            <svg className="flex-shrink-0" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00D9FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
            </svg>
            <div>
              <p className="font-['Orbitron'] font-bold text-[16px] md:text-[18px] text-[#00D9FF]">7 dias de garantia incondicional</p>
              <p className="mt-1 font-['Inter'] font-light text-[14px] md:text-[16px] text-white">
      ...
      <section className="px-4 py-20 flex flex-col items-center">
        ...
        <p className="mt-4 font-['Inter'] font-light text-[16px] md:text-[18px] text-white text-center">
          Tire suas dúvidas antes de começar
        </p>

        <div className="mt-12 max-w-[700px] w-full flex flex-col gap-4">
          {faqs.map((faq, index) => (
            <div key={index} className="border border-[#00D9FF] rounded-lg overflow-hidden">
              <button
                onClick={() => setOpenFaq(openFaq === index ? null : index)}
                className="w-full flex items-center justify-between px-5 md:px-6 py-5 bg-transparent cursor-pointer text-left"
              >
                <span className="font-['Orbitron'] font-medium text-[15px] md:text-[18px] text-white pr-4">
                  {faq.pergunta}
                </span>
                <svg
                  width="20"
              ...
              >
                <p className="px-5 md:px-6 pb-5 font-['Inter'] font-light text-[15px] md:text-[16px] leading-[24px] text-white/80">
                  {faq.resposta}
                </p>
              </div>
            </div>
